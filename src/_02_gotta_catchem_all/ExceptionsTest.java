...
class ExceptionsTest {
	...
	public void testDivideByZeroException() {
		try {
			assertEquals(1.0, ExceptionMethods.divide(2.5, 2.5));
			assertEquals(0.0, ExceptionMethods.divide(3.4, 0.0));
	...
	public void testReverseString() {
		try {
			assertEquals("olleh", ExceptionMethods.reverseString("hello"));
